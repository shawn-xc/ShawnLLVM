  ...
  MultilibSet RISCVMultilibs =
      MultilibSetBuilder()
          ...
          .setFilePathsCallback([EndiannessSuffix](const Multilib &M) {
            return std::vector<std::string>(
                {M.gccSuffix(),
                 "/../../../../riscv64" + EndiannessSuffix + "-unknown-elf/lib" + M.gccSuffix(),
                 "/../../../../riscv32" + EndiannessSuffix + "-unknown-elf/lib" + M.gccSuffix()});
          });
...
static void findRISCVMultilibs(const Driver &D,
  ...
  Multilib::flags_list Flags;
  bool IsRV64 = (TargetTriple.getArch() == llvm::Triple::riscv64 || TargetTriple.getArch() == llvm::Triple::riscv64be);;
  StringRef ABIName = tools::riscv::getRISCVABI(Args, TargetTriple);
