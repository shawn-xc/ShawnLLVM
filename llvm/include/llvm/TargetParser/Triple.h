...
public:
  enum ArchType {
    ...
    riscv32be,      // RISC-V (32-bit): riscv32 big-endian
    riscv64be,      // RISC-V (64-bit): riscv64 big-endian
    sparc,          // Sparc: sparc
...
public:
  ...
  bool isRISCV32() const { return getArch() == Triple::riscv32 || getArch() == Triple::riscv32be; }

  /// Tests whether the target is 64-bit RISC-V.
  bool isRISCV64() const { return getArch() == Triple::riscv64 || getArch() == Triple::riscv64be;  }
